clear all
%load dat/sim_section_size_increase_zero_churn_adv_net_age_16_adv_0.2.dat
load sim_section_size_increase_zero_churn_adv_net_age_12_adv_0.05.dat
...
filename = [...
    'section_model_zero_churn_adv_malicious_nodes_vs_section_size',...
...
filename = [...
    'section_model_zero_churn_adv_malicious_elders_vs_section_size',...
    '_age_', num2str(initial_network_age), ...
    '_adversary_', num2str(fraction_of_new_nodes_are_malicious), ...
    '_n_', num2str(network_iterations), ...
    '_size_', num2str(network_size), ...
...
for ii = 1:length(number_of_sections)
    ...
    filename = [...
        'section_model_zero_churn_adv_malicious_per_section',...
        '_age_', num2str(initial_network_age), ...
        '_adversary_', num2str(fraction_of_new_nodes_are_malicious), ...
