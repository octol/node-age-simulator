...
filename = [...
    'section_model_malicious_nodes_vs_section_size_fix_elders_', num2str(num_of_elders(1)),...
...
filename = [...
    'section_model_malicious_elders_vs_section_size_fix_elders_', num2str(num_of_elders(1)),...
    '_age_', num2str(initial_network_age), ...
    '_adversary_', num2str(fraction_of_new_nodes_are_malicious), ...
    '_n_', num2str(network_iterations), ...
    '_size_', num2str(network_size), ...
...
for ii = 1:length(number_of_sections)
    ...
    filename = [...
        'section_model_malicious_per_section_fix_elders_',...
        '_age_', num2str(initial_network_age), ...
        '_adversary_', num2str(fraction_of_new_nodes_are_malicious), ...
